  ...
  return (
    <footer className="footer-section">
      <div className="footer-container">
        ...
        {/* Content Row: Description & Nav Links */}
        <div className="footer-content-row">
          <p className="footer-description">
            REMAX Capital is a premier real estate brokerage under REMAX Philippines, delivering expert guidance in buying, selling, and leasing properties.
          </p>
        ...
        {/* Bottom Row: Legal, Dark Mode toggle, Socials */}
        <div className="footer-bottom-row">
          <div className="footer-legal">
            <span>© REMAX Capital 2026. All Rights Reserved.</span>
            <span className="footer-meta">
              View site in <button className="footer-theme-toggle">🌙 Dark Mode</button> · Powered by <span className="powered-text">AiSi</span>
            </span>
          </div>
