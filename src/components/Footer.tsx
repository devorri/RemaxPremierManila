      ...
      <div className="footer-container">
        ...
        <div className="footer-content-row">
          <p className="footer-description">
            REMAX Premier is a real estate brokerage under REMAX Philippines, delivering expert guidance in buying, selling, and leasing properties.
          </p>
        ...
        <div className="footer-bottom-row">
          <div className="footer-legal">
            <span>© REMAX Premier 2026. All Rights Reserved.</span>
            <span className="footer-meta">
              View site in <button className="footer-theme-toggle">🌙 Dark Mode</button> · Powered by <span className="powered-text">TomasDev</span>
            </span>
          </div>
